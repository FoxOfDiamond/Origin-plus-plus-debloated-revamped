...
execute as @e[tag=tail_armorstand] run function overhaul:ninetales_functions/tail_armorstand
...
execute as @e[tag=tail_display] run function overhaul:ninetales_functions/tail_display
